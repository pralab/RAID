...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--elsa_d3_data_path', default=None, help='''only used if data_mode==elsa_d3 it should contain train and validation folders in which there are 5 folders: 
                            4 of images generated by 4 different fake image generators and one folder of real images''')
    ...
    def print_options(self, opt):
        ...
        # save to the disk
        expr_dir = os.path.join(opt.checkpoints_dir, 'ohja2023', opt.name)
        #util.mkdir(expr_dir)
